...
phina.define("nfc.EnemyManager",{superClass:"nfc.SimpleUpdater",definedenemy:[],definedenemynames:[],init:function(e,t){this.superInit(),this.scene=e,this.threescene=t,this.effectmanager=new nfc.EffectManager(t).addChildTo(this)},defineEnemy:function(e,t,n){this.definedenemy[e]={mesh:phina.asset.AssetManager.get("threejson",e).get(),routine:t.$safe({hp:5,size:1,v:0,c:new THREE.Quaternion,time:0,update:function(){}}),autospawn:(n||{}).$safe({rep:1,options:{}})},this.definedenemynames.push(e)},createEnemy:function(e,t,n,i){if(i){var s=function(a){a.progress>i&&(this.createEnemy(e,t,n),this.off("frame",s))}.bind(this);this.on("frame",s)}else{if(!n){var a=this.definedenemy[e].mesh.clone();return THREE.$extend(a,this.definedenemy[e].routine),THREE.$extend(a,t),this.threescene.add(a),this.elements.push(a),a}this.on("frame"+n,function(){this.createEnemy(e,t)}.bind(this))}},createEnemyMulti:function(e,t,n){for(var i=n.$safe(this.definedenemy[e].autospawn),s=0;s<i.rep;s++)this.createEnemy(e,t,i.time,i.progress),i.delay&&(i.time+=i.delay),THREE.$add(t,i.options),THREE.$add(t,i.random)},update:function(){for(var e=0;e<this.count();e++)this.get(e).update(),this.get(e).hp<=0&&(this.effectmanager.explode(this.get(e).position,this.get(e).size,this.get(e).explodeTime),this.scene.score+=this.get(e).size,this.remove(e),e--)},remove:function(e){this.get(e).parent.remove(this.get(e)),this.elements.splice(e,1)}});
