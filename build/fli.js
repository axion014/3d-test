	...
	init: function(options) {
		...
		this.load([
			function(resolve) { // Screen Setup
				...
				var directionalLight = new THREE.DirectionalLight(0xffffff, 1); //ï¿½ï¿½ï¿½sï¿½ï¿½ï¿½ï¿½(ï¿½ï¿½, ï¿½ï¿½ï¿½x)
				directionalLight.position.set(0, 0, 30);
				layer.scene.add(directionalLight);
				layer.scene.add(new THREE.AmbientLight(0x606060)); // ï¿½Â‹ï¿½ï¿½ï¿½(ï¿½Oï¿½ï¿½ï¿½[)
				...
				layer.update = function(app) { // Update routine
					...
					if (this.bosscoming && gauge_boss_h.alpha < 1) {
